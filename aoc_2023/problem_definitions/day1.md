 Day 2 - Advent of Code 2023    window.addEventListener('click', function(e,s,r){if(e.target.nodeName==='CODE'&&e.detail===3){s=window.getSelection();s.removeAllRanges();r=document.createRange();r.selectNodeContents(e.target);s.addRange(r);}});
...
[TNG Technology Consulting](https://www.tngtech.com/en/) - We solve hard IT problems - all year round!
